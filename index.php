            ...
            <div class="banner-info">
              <div class="container">
                <div class="banner-info-bg">
                  <h5>Medicine </h5>
                  <p>We allow medical professionals to evaluate,diagnose and treat patients at a distance using telecommunications technology.</p>
          ...
          <div class="slider-info banner-view banner-top2 bg bg2">
            <div class="banner-info">
              <div class="container">
                <div class="banner-info-bg">
                  <h5>Health</h5>
                  <p>A broader scope of remote health care services than telemedicine. Telemedicine refers specifically to remote clinical services, while telehealth can refer to remote non-clinical services.
                  </p>
                    <a class="btn btn-style btn-style-outline mt-sm-5 mt-4" href="services.html"> Our Services</a>
                </div>
              </div>
